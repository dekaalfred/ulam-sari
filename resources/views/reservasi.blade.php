...
<div
    ...
    <div class="bg-white rounded-2xl max-w-md w-full max-h-[90vh] flex flex-col text-center relative shadow-2xl border border-gray-100">
        ...
        <!-- ===== FOOTER TOMBOL - SELALU NEMPEL DI BAWAH, TIDAK IKUT SCROLL ===== -->
        <div class="p-6 pt-4 space-y-2 border-t border-gray-100 flex-shrink-0">
...
>>>>>>> 4ffaaf9b71665ca072c78e1a9ea804104765f69a
        </div>
