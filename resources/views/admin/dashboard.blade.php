    ...
    <div class="w-full max-w-md bg-white p-8 rounded-2xl border border-stone-200 shadow-sm space-y-6">
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-4">
            ...
            <div>
                ...
                <input type="email" name="email" required class="w-full px-4 py-2.5 rounded-lg border border-stone-300 text-sm focus:outline-none focus:border-[#C86D3B]" placeholder="admin@ulamsari.com">
            </div>
